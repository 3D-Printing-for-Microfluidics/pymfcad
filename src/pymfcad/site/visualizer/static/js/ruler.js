...
export class RulerAxesHelper extends THREE.AxesHelper {
    ...
    _createTickGroup() {
        ...
        group.userData.minorTicks = new THREE.LineSegments(minorGeometry, minorMaterial);
        group.userData.majorTicks = new THREE.LineSegments(majorGeometry, majorMaterial);
        this._tickChildren.push(group.userData.minorTicks, group.userData.majorTicks);
