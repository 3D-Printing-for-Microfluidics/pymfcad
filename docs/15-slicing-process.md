...
This final step shows how to generate a print file for a complete component assembly. Use the assembly from Part 11/13, **replace the valve with your updated valve**, and then generate the print bundle.
...
## Step 2 — Attach print inputs (Part 13)

Here you create the printer and resin profiles so `PrintFileGenerator` can validate hardware compatibility and compute exposure and motion metadata.
...
+    purpose="Test device",
+    description="Learn to design and slice custom microfluidic device.",
+    component=device,
+    printer=printer,
+    resin=resin,
+    minimize_file=True,
