...
c1 = Valve20px("Valve1").translate((18, 35, 40))
c2 = Valve20px("Valve2").translate((52, 35, 40))
...
r.autoroute_channel(c2.get_port("F_OUT"), c1.get_port("F_IN"), nettype="autopath")
r.autoroute_channel(c1.get_port("P_OUT"), c2.get_port("F_IN"), nettype="autopath")
r.autoroute_channel(c1.get_port("F_OUT"), c2.get_port("P_IN"), nettype="autopath")
r.autoroute_channel(c2.get_port("P_OUT"), c1.get_port("P_IN"), nettype="autopath")
r.route()
