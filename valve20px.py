...
class Valve20px(Component):
    def __init__(self, name):
        ...
        self.add_port(Port(self, "F_IN", Port.PortType.IN, (15, 15, 0), (6, 6, 4), Port.Pointing_Vector.NEG_Z))
        self.add_port(Port(self, "F_OUT", Port.PortType.OUT, (14, 36, 0), (8, 8, 6), Port.Pointing_Vector.POS_Y))
        self.add_port(Port(self, "P_IN", Port.PortType.INOUT, (14, 0, 12), (8, 8, 6), Port.Pointing_Vector.NEG_Y))
        self.add_port(Port(self, "P_OUT", Port.PortType.INOUT, (14, 36, 12), (8, 8, 6), Port.Pointing_Vector.POS_Y))
