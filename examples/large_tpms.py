...
outer.add_default_position_settings(
    PositionSettings(
        distance_up=1.0,
        up_speed=50.0,
...
outer_bulk = Cube((1000, 600, 100)).translate(
    (outer._size[0] / 2 - 500, outer._size[1] / 2 - 300, 0)
)
...
chan_list += [
    ...
    PolychannelShape(
        "sphere", position=(pinhole_l, 0, 0), size=(0, pinhole_d, pinhole_d)
    ),
    PolychannelShape("cube", position=(0, 0, 0), size=(0, channel_w, channel_h)),
    PolychannelShape(
        "cube",
        position=(80, 0, 0),
...
for i in range(10):
    chan_list += [
        ...
        PolychannelShape(
            "cube", position=(-440, 0, 0), size=(channel_w, channel_w, channel_h)
        ),
        PolychannelShape(
            "cube", position=(0, 20, 0), size=(channel_w, channel_w, channel_h)
        ),
    ]
...
stitched_wintech.add_default_position_settings(
    PositionSettings(
        distance_up=0.5,
        up_speed=25.0,
        up_acceleration=1.0,
...
translation_x = (
    outer._size[0] * outer._px_size
    - stitched_wintech._size[0] * stitched_wintech._px_size
) / 2
translation_y = (
    outer._size[1] * outer._px_size
    - stitched_wintech._size[1] * stitched_wintech._px_size
) / 2
stitched_wintech.translate(
    (translation_x / outer._px_size, translation_y / outer._px_size, 90)
